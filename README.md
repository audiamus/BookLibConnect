...
## Download
Windows setup package version 0.7, English, with manual:

**[BookLibConnect-0.7-Setup.exe](https://github.com/audiamus/BookLibConnect/releases/download/v0.7/BookLibConnect-0.7-Setup.exe)**
